...
public class SwerveModule
{
                      ...
                      SimpleMotorFeedforward driveFeedforward)
  {
    ...
    angleMotor.configurePIDWrapping(0, Math.PI);
  ...
  public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop, boolean force)
  {
    ...
    if (absoluteEncoder != null && synchronizeEncoderQueued)
    {
      ...
      angleMotor.setReference(desiredState.angle.getRadians(), 0, absoluteEncoderPosition);
      synchronizeEncoderQueued = false;
    } else
    {
      angleMotor.setReference(desiredState.angle.getRadians(), 0);
    }
  ...
  {
    //Temporary workaround, delete this function if using this code for real
    //return degrees;
  ...
  {
    angleMotor.setReference(degreesToRadians(angle), 0);
  ...
  public double getAbsolutePosition()
  {
    ...
    if (absoluteEncoder != null)
    {
      angle = radiansToDegrees(absoluteEncoder.getAbsolutePosition()) - angleOffset;
  ...
  {
    return radiansToDegrees(angleMotor.getPosition());
  }
  ...
  public void updateTelemetry()
  {
    ...
    SmartDashboard.putNumber("Module[" + configuration.name + "] Raw Motor Encoder", radiansToDegrees(angleMotor.getPosition()));
